...
import ca.judacribz.week3day4_contentprovider.dummy.DummyContent;

import java.util.List;

/**
 * An activity representing a list of poke list. This activity
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    intent.putExtra(pokemonDetailFragment.ARG_ITEM_ID, item.id);
